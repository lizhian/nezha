...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "settings.quickRun": "Quick Run Configuration",
    "settings.quickRunScript": "Shell Script",
    "settings.quickRunScriptHint": "Shows a Run button on active tasks and executes this script in the project or worktree directory.",
    "settings.quickRunScriptPlaceholder": "e.g. pnpm dev",
    "settings.git": "Git",
    ...
    "terminal.quickRunTitle": "run",
    "terminal.closeQuickRun": "Close Run Terminal",
  ...
  zh: {
    ...
    "settings.quickRun": "快速运行配置",
    "settings.quickRunScript": "Shell 脚本",
    "settings.quickRunScriptHint": "在运行中任务上显示“运行”按钮，并在项目目录或工作树目录执行这段脚本。",
    "settings.quickRunScriptPlaceholder": "例如：pnpm dev",
    "settings.git": "Git",
    ...
    "terminal.title": "终端",
    "terminal.quickRunTitle": "运行",
    "terminal.closeQuickRun": "关闭运行终端",
